...
const Hyperspeed = ({ effectOptions }) => {
  ...
  useEffect(() => {
    ...
    // Default options with CI/CD platform color scheme
    ...
    class Road {
      ...
      createPlane(side, width, isRoad) {
        ...
        const material = new THREE.ShaderMaterial({
          ...
          side: THREE.DoubleSide,
          uniforms: Object.assign(uniforms, this.webgl.fogUniforms, (options.distortion && options.distortion.uniforms) || {})
        });
    ...
    (function () {
      ...
      // Ensure options.distortion is properly set
